...
import { ChevronRightIcon, Bars3Icon, CreditCardIcon, LockClosedIcon, HomeIcon, UsersIcon, TicketIcon, XMarkIcon } from "@heroicons/react/24/outline";
import { useDashboard } from "../../context/DashboardProvider";

const navigation = [
  { name: "Dashboard", icon: HomeIcon, page: 1 },
  { name: "My Tickets", icon: TicketIcon, page: 2 },
  { name: "My Prizes", icon: TicketIcon, page: 3 },
  {
    name: "My Account",
    icon: UsersIcon,
    page: 4,
