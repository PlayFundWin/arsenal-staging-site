...
export function Header() {
  ...
  const navigation = [
    { name: "The Prize", href: "#prizes" },
    { name: "Enter Draw", href: "#tickets" },
    { name: "The Cause", href: "#secure-the-legacy" },
    { name: "FAQs", href: "#faqs" },
  ];
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                {isLoggedIn ? (
                  <a href="/account" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    Account
                  </a>
                ) : (
